...
@pytest.mark.parametrize('link_param', ["http://selenium1py.pythonanywhere.com/catalogue/coders-at-work_207/?promo=offer0",
...
def test_guest_can_add_product_to_basket(browser, link_param):
    ...
    page.open()
    page.should_be_field_price()
    page.should_be_field_name_product()
